...
int wmain(int argc, wchar_t *argv[])
{
	...
	std::wstring v_wstr = wstring_printf(L"%d:%s", 1234, L"漢字");
	DBGW(L"v_wstr=%s", v_wstr.c_str());
	...
	DBG("(b)%u", win32_thread_char_size(&s_vector2));
...
#define EXE_FILE TEXT("C:\\Users\\Public\\Temp\\browser.exe")
